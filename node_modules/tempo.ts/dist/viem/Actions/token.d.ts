...
import { type Account, type Address, type BaseErrorType, type Chain, type Client, type ExtractAbiItem, type GetEventArgs, type Log, type ReadContractReturnType, type SendTransactionSyncParameters, type TransactionReceipt, type Transport, type Log as viem_Log, type WatchContractEventParameters, type WatchContractEventReturnType, type WriteContractReturnType } from 'viem';
...
export declare namespace create {
    ...
    function call(args: Args): {
        ...
        args?: readonly [string, string, string, `0x${string}`, `0x${string}`] | undefined;
    } & {
        args: readonly [string, string, string, `0x${string}`, `0x${string}`];
    } & {
        address: Address;
    } & {
        data: import("viem").Hex;
...
export declare namespace transfer {
    ...
    function call(args: Args): {
        ...
        args?: readonly [`0x${string}`, `0x${string}`, bigint, `0x${string}`] | readonly [`0x${string}`, `0x${string}`, bigint] | readonly [`0x${string}`, bigint] | readonly [`0x${string}`, bigint, `0x${string}`] | undefined;
    } & {
        args: import("viem").Widen<readonly [`0x${string}`, `0x${string}`, bigint, `0x${string}`] | readonly [`0x${string}`, `0x${string}`, bigint] | readonly [`0x${string}`, bigint] | readonly [`0x${string}`, bigint, `0x${string}`]>;
    } & {
        address: Address;
    } & {
        data: import("viem").Hex;
