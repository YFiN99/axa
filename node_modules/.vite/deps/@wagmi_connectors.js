import {
  ...
  injected,
  mock
} from "./chunk-KCIJVXTR.js";
import {
  withRetry,
  withTimeout
} from "./chunk-AHNFSNHP.js";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./connectors-7Y55OXVV.js");
...
function coinbaseWallet(parameters = {}) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await import("./connectors-MZP6XANX.js");
...
function gemini(parameters = {}) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      var _a, _b, _c, _d;
      if (!walletProvider) {
        const { GeminiWalletProvider } = await import("./connectors-KYFQFC3Q.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./connectors-PIKCVVZL.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./connectors-QLR6E4H7.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./connectors-KXT264DF.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./connectors-SCK2HWJH.js");
